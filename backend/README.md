...
## Project Structure
    ...
    ├── testapiautocatalog_120870  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_120870`
...
2. Clone this repo and `cd testapiautocatalog_120870`
